/****************************************************************************
** Meta object code from reading C++ file 'DisplayController.h'
**
...
#include "../../GE-CS600-DemoVersion/Controller/DisplayController.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'DisplayController.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DisplayController_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject DisplayController::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_DisplayController.data,
    qt_meta_data_DisplayController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *DisplayController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DisplayController.stringdata0))
